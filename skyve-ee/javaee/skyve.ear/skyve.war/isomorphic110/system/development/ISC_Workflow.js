...
isc.defineClass("Process","Task");isc.A=isc.Process;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$89p={};isc.B.push(isc.A.loadProcess=function isc_c_Process_loadProcess(_1,_2){var _3=isc.DataSource.get("WorkflowLoader");_3.fetchData({id:_1},function(_8,_9,_10){var _4=null;var _5=_9.content;if(_5!=null){if(isc.isAn.Array(_5)){_4=isc.Class.evaluate(_5[0]);_4.ID=_1[0];isc.Process.$89p[_1[0]]=_4;for(var i=1;i<_5.length;i++){var p=isc.Class.evaluate(_5[i]);p.ID=_1[i];isc.Process.$89p[_1[i]]=p}}else{_4=isc.Class.evaluate(_5);_4.ID=_1;isc.Process.$89p[_1]=_4}}else{isc.logWarn("File named \""+_1+"\".proc.xml could not be found in the search path specified by \"project.processes\".")}
_2(_4)})},isc.A.getProcess=function isc_c_Process_getProcess(_1){return isc.Process.$89p[_1]});isc.B._maxIndex=isc.C+2;isc.A=isc.Process.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.autoStart=false;isc.B.push(isc.A.init=function isc_Process_init(){var _1=this.Super("init",arguments);this.$1464=this.startElement;if(this.autoStart)this.start();return _1},isc.A.getElement=function isc_Process_getElement(_1){return this.$1465(this,_1)},isc.A.setState=function isc_Process_setState(_1){this.state=_1},isc.A.$1465=function isc_Process__searchElement(_1,_2){if(_1.sequences){for(var i=0;i<_1.sequences.length;i++){var s=_1.sequences[i];if(s.ID==_2){return s}else if(s.sequences||s.elements){var _5=this.$1465(s,_2);if(_5)return _5}}}
if(_1.elements){for(var i=0;i<_1.elements.length;i++){var e=_1.elements[i];if(e.ID==_2){return e}else if(e.sequences||e.elements){var _5=this.$1465(e,_2);if(_5)return _5}}}},isc.A.start=function isc_Process_start(){if(this.executionStack==null){this.executionStack=[]}
if(this.state==null)this.state={};while(this.$142x()){var _1=this.$1466();if(_1){this.$1467=true;if(!_1.executeElement(this)){return}}}
if(this.finished){this.startElement=this.$1464;this.finished(this.state)}},isc.A.reset=function isc_Process_reset(_1){this.state=_1;this.executionStack=null},isc.A.$142x=function isc_Process__next(){var _1=this.executionStack.last();if(_1==null){if(this.startElement){var _2=this.$1468(this,this.startElement);if(_2==null){isc.logWarn("unable to find task '"+this.startElement+"' - process will be finished")}
return _2}else if(this.$1467){return null}else if(this.sequences&&this.sequences.length>0){this.executionStack.add({el:this,sIndex:0});return this.sequences[0]}else if(this.elements&&this.elements.length>0){this.executionStack.add({el:this,eIndex:0});return this.elements[0]}else{isc.logWarn("There are neither sequences or elements. Nothing to execute.")}}else{var _3=null;if(_1.sIndex!=null){_3=_1.el.sequences[_1.sIndex]}else if(_1.eIndex!=null){_3=_1.el.elements[_1.eIndex]}
if(_3.nextElement){this.executionStack=[];var _2=this.$1468(this,_3.nextElement);if(_2==null){isc.logWarn("unable to find task '"+_3.nextElement+"' - process will be finished")}
return _2}else{return this.$1469()}}},isc.A.$1468=function isc_Process__gotoElement(_1,_2){var _3={el:_1};this.executionStack.add(_3);if(_1.sequences){for(var i=0;i<_1.sequences.length;i++){var s=_1.sequences[i];_3.sIndex=i;if(s.ID==_2){return s}else if(s.sequences||s.elements){var _6=this.$1468(s,_2);if(_6)return _6}}}
delete _3.sIndex;if(_1.elements){for(var i=0;i<_1.elements.length;i++){var e=_1.elements[i];_3.eIndex=i;if(e.ID==_2){return e}else if(e.sequences||e.elements){var _6=this.$1468(e,_2);if(_6)return _6}}}
this.executionStack.removeAt(this.executionStack.length-1)},isc.A.$1469=function isc_Process__findNextElement(){var _1=this.executionStack.last();if(_1.eIndex!=null&&_1.el!=this){if(_1.eIndex==_1.el.elements.length-1){this.executionStack.removeAt(this.executionStack.length-1);if(_1.el==this){return}else{return this.$1469()}}else{_1.eIndex++;return _1.el.elements[_1.eIndex]}}},isc.A.$1466=function isc_Process__getFirstTask(){var _1=this.executionStack.last();var _2=null;if(_1.sIndex!=null){_2=_1.el.sequences[_1.sIndex]}else if(_1.eIndex!=null){_2=_1.el.elements[_1.eIndex]}
...
var _5=this.$1466(_2.sequences[i]);if(_5)return _5}}
if(_2.elements){for(var i=0;i<_2.elements.length;i++){_3.eIndex=i
var _5=this.$1466(_2.elements[i]);if(_5)return _5}}
...
var _7=null;if(this.operationType=="fetch"){if(this.criteria){_7=this.criteria;this.$147a(_7,_3)}
...
_1.start()});return false},isc.A.$147a=function isc_ServiceTask__processCriteriaExpressions(_1,_2){for(var _3 in _1){if(isc.isAn.Array(_1[_3])){for(var i=0;i<_1[_3].length;i++){this.$147a(_1[_3][i],_2)}}else if(_3=="criteria"){this.$147a(_1.criteria,_2)}else if(isc.isA.String(_1[_3])){if(_1[_3].startsWith("$input")){var _5="state."+_1[_3].replace("$input",this.inputField);_1[_3]=isc.Class.evaluate(_5,{state:_2})}else if(_1[_3].startsWith("$inputRecord")){var _5=_1[_3].replace("$inputRecord","state");_1[_3]=isc.Class.evaluate(_5,{state:_2})}}}});isc.B._maxIndex=isc.C+2;isc.defineClass("ScriptTask","Task");isc.A=isc.ScriptTask.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.isAsync=false;isc.B.push(isc.A.getInputData=function isc_ScriptTask_getInputData(){return this.inputData},isc.A.setOutputData=function isc_ScriptTask_setOutputData(_1){this.$147b(this.process,null,_1)},isc.A.getInputRecord=function isc_ScriptTask_getInputRecord(){return this.inputRecord},isc.A.setOutputRecord=function isc_ScriptTask_setOutputRecord(_1){this.$147b(this.process,_1)},isc.A.executeElement=function isc_ScriptTask_executeElement(_1){var _2;var _3;if(this.inputFieldList){_3={};for(var i=0;i<this.inputFieldList.length;i++){_3[this.inputFieldList[i]]=_1.getStateVariable(this.inputFieldList[i])}}
...
this.$147c(_1,_5);return true},isc.A.$147c=function isc_ScriptTask__processTaskOutput(_1,_2){if(this.outputFieldList){for(var i=0;i<this.outputFieldList.length;i++){var _4=this.outputFieldList[i];if(typeof _2[_4]!='undefined'){_1.setStateVariable(_4,_2[_4])}}}
if(this.outputField){if(this.outputFieldList==null){if(typeof _2!='undefined'){_1.setStateVariable(this.outputField,_2)}}else{if(typeof _2[this.outputField]!='undefined'){_1.setStateVariable(this.outputField,_2[this.outputField])}}}},isc.A.$147b=function isc_ScriptTask__finishTask(_1,_2,_3){if(_2==null){this.$147c(_1,_3)}else{if(_3){_2[this.outputField]=_3}
this.$147c(_1,_2)}
if(this.isAsync){_1.start()}});isc.B._maxIndex=isc.C+7;isc.ScriptTask.registerStringMethods({execute:"input,inputRecord"});isc.defineClass("XORGateway","ProcessElement");isc.A=isc.XORGateway;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.$147d=function isc_c_XORGateway__processFieldsRecursivelyValuesOnly(_1){var _2=[];if(_1.fieldName){if(!_2.contains(_1.fieldName)){_2.add(_1.fieldName)}}else if(_1.criteria){for(var i=0;i<_1.criteria.length;i++){var _4=this.$147d(_1.criteria[i]);for(var j=0;j<_4.length;j++){if(!_2.contains(_4[j])){_2.add(_4[j])}}}}else{for(var _6 in _1){if(!_2.contains(_6)){_2.add(_6)}}}
return _2},isc.A.$147e=function isc_c_XORGateway__processFieldsRecursively(_1){var _2=[];var _3=isc.XORGateway.$147d(_1);for(var i=0;i<_3.length;i++){_2.add({name:_3[i]})}
return _2});isc.B._maxIndex=isc.C+2;isc.A=isc.XORGateway.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.executeElement=function isc_XORGateway_executeElement(_1){var _2=isc.XORGateway.$147e(this.criteria);var _3=isc.DataSource.create({fields:_2});if(_3.applyFilter([_1.state],this.criteria).length==1){if(this.nextElement)_1.setNextElement(this.nextElement)}else{if(this.failureElement)_1.setNextElement(this.failureElement)}
return true});isc.B._maxIndex=isc.C+1;isc.defineClass("DecisionGateway","ProcessElement");isc.A=isc.DecisionGateway.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.executeElement=function isc_DecisionGateway_executeElement(_1){for(var _2 in this.criteriaMap){var _3=isc.XORGateway.$147e(this.criteriaMap[_2]);var _4=isc.DataSource.create({fields:_3});if(_4.applyFilter([_1.state],this.criteriaMap[_2]).length==1){_1.setNextElement(_2);return true}}
