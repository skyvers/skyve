...
public class SqlQueryUtil {
	 ...
	 * @throws Exception
	 */
	public static List<DynaBean> retrieveDynamicResults(final String query, final Integer... limit) throws Exception {
		if (query != null) {
	 ...
	 * @throws Exception
	 */
	public static List<DynaBean> retrieveDynamicResults(final String query, final Map<String, Object> parameters) throws Exception {
		if (query != null) {
			try (Connection connection = EXT.getDataStoreConnection()) {
