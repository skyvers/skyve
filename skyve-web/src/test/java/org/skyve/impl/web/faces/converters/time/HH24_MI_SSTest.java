...
public class HH24_MI_SSTest {
	...
	public void testGetAsObjectValidFormatAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsObject(null, null, "02:30:05"), is(testDate));
	}
	...
	public void testGetAsObjectValidFormatPM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsObject(null, null, "14:30:05"), is(testDate));
	}
	...
	public void testGetAsStringAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsString(null, null, testDate), is("02:30:55"));
	}
	...
	public void testGetAsStringPM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsString(null, null, testDate), is("14:30:55"));
	}
}
