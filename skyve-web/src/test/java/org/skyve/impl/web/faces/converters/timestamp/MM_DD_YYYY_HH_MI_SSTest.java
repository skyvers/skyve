...
public class MM_DD_YYYY_HH_MI_SSTest {
	private MM_DD_YYYY_HH_MI_SS formatter;
	...
	public void testGetAsObjectValidFormatAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsObject(null, null, "03/01/2020 02:30:55 AM"), is(testDate));
	}
	...
	public void testGetAsObjectValidFormatPM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsObject(null, null, "03/01/2020 02:30:55 PM"), is(testDate));
	}
	...
	public void testGetAsStringAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsString(null, null, testDate), is("03/01/2020 02:30:55 AM"));
	}
	...
	public void testGetAsStringPM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsString(null, null, testDate), is("03/01/2020 02:30:55 PM"));
	}
}
