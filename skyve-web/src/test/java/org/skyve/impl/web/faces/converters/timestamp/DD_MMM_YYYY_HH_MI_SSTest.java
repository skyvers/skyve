...
public class DD_MMM_YYYY_HH_MI_SSTest {
	...
	public void testGetAsObjectValidFormatAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsObject(null, null, "01-Mar-2020 02:30:55 AM"), is(testDate));
	}
	...
	public void testGetAsObjectValidFormatPM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsObject(null, null, "01-Mar-2020 02:30:55 PM"), is(testDate));
	}
	...
	public void testGetAsStringAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsString(null, null, testDate), is("01-Mar-2020 02:30:55 AM"));
	}
	...
	public void testGetAsStringPM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.getAsString(null, null, testDate), is("01-Mar-2020 02:30:55 PM"));
	}
}
