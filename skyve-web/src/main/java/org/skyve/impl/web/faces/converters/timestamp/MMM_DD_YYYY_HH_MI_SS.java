...
public class MMM_DD_YYYY_HH_MI_SS extends org.skyve.domain.types.converters.timestamp.MMM_DD_YYYY_HH_MI_SS implements Converter {
	@Override
	public Object getAsObject(FacesContext fc, UIComponent component, String value) {
    	...
    	if (processedValue != null) {
			try {
				...
				String message = "Invalid date/time (use MON-DD-YYYY HH:MI:SS AM/PM format)";
