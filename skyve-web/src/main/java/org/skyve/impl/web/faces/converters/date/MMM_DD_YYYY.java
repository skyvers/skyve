...
public class MMM_DD_YYYY extends org.skyve.domain.types.converters.date.MMM_DD_YYYY implements Converter {
	@Override
	public Object getAsObject(FacesContext fc, UIComponent component, String value) {
    	...
    	if (processedValue != null) {
			try {
				...
				String message = "Invalid date (use MON-DD-YYYY format)";
