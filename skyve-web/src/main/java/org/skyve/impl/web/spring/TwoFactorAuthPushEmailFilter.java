...
public class TwoFactorAuthPushEmailFilter extends TwoFactorAuthPushFilter {
	...
	public static final String SYSTEM_TWO_FACTOR_CODE_BODY = "Hi %s,<br /><br />" +
	...
	@Override
	protected void pushNotifcation(UserTFA user, String code) {
		UtilImpl.LOGGER.info("2fa code push notification code is : " + code ); 
		
		String emailAddress = getUserEmail(user);
		if (com.google.common.base.Strings.isNullOrEmpty(emailAddress)) {
	...
	private String getUserEmail(UserTFA user) {
