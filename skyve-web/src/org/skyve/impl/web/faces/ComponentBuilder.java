...
public class ComponentBuilder {
	...
	public HtmlPanelGroup panelGroup(boolean nowrap, boolean middle, boolean blockLayout, String invisible) {
	...
	public HtmlPanelGroup responsiveRow(String invisible) {
		HtmlPanelGroup result = panelGroup(false, false, false, invisible);
		result.setStyleClass("ui-g");
		return result;
	}

	public HtmlPanelGroup responsiveColumn(Integer cols, 
											Integer smCols, 
											Integer mdCols, 
											Integer lgCols, 
											Integer xlCols,
											...
											String invisible) {
		HtmlPanelGroup result = panelGroup(false, false, false, invisible);
		StringBuilder styleClass = new StringBuilder(32);
		if (cols != null) {
			styleClass.append("ui-g-").append(cols);
		}
		if (smCols != null) {
			styleClass.append(" ui-sm-").append(smCols);
		}
		if (mdCols != null) {
			styleClass.append(" ui-md-").append(mdCols);
		}
		if (lgCols != null) {
			styleClass.append(" ui-lg-").append(lgCols);
		}
		if (xlCols != null) {
			styleClass.append(" ui-xl-").append(xlCols);
		}
		if (nopad) {
			styleClass.append(" ui-g-nopad");
		}
		result.setStyleClass(styleClass.toString());
		return result;
	}
	...
	public HtmlOutputLabel label(String listBinding, String binding, String value, String forId) {
		...
		if (forId != null) {
			...
			setId(result);
			result.setFor(forId);
			// result.setValueExpression("for", ef.createValueExpression(elc, forId, String.class));
		} 
		else {
	...
	public Tab tab(String title, String disabled, String invisible) {
	 ...
	 */
	public Button reportButton(String value, 
								String title,
	 ...
	 * </h:link>
	 */
	public HtmlOutputLink outputLink(String value, String outcome, String disabled, String invisible) {
	...
	public HtmlOutputLink outputLink(String listBinding, 
		...
		if (listBinding != null) {
			result.setValueExpression("value",
										createValueExpressionFromBinding(listBinding, href, true, null, String.class));
		}
		else {
	...
	public Button linkButton(String icon, 
								String styleClass, 
								String style, 
								String value, 
								String title, 
	...
	public SelectBooleanCheckbox checkbox(String bindingPrefix, 
											...
											String disabled, 
											boolean mobile) {
		SelectBooleanCheckbox result = (SelectBooleanCheckbox) input(SelectBooleanCheckbox.COMPONENT_TYPE,
																		bindingPrefix, 
																		binding, 
																		title, 
																		required, 
	...
	public AutoComplete autoComplete(String bindingPrefix, 
		...
		addSize(result, 
					...
					null, 
					null,
					applyDefaultWidth ? NINETY_FIVE : null);

		return result;
	}

	public Button button(String icon, String styleClass, String style) {
	...
	public Editor editor(String bindingPrefix, String binding, String title, boolean required, String disabled) {
	...
	private void addDisabled(UIComponent component, String disabled) {
		if (disabled != null) {
			component.setValueExpression("disabled", createValueExpressionFromCondition(disabled, null));
		}
	}

	private void addInvisible(UIComponent component, String invisible, String extraELToAppend) {
		if (invisible != null) {
