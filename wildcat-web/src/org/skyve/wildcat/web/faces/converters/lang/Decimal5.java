...
/**
 * Convert a Decimal5 to and from a string respecting null values.
 * @author mike
 */
public class Decimal5 implements Converter {
    @Override
    ...
    public java.lang.String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value instanceof org.skyve.domain.types.Decimal5) {
