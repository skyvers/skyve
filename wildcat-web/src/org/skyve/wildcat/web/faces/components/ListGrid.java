...
public class ListGrid extends HtmlPanelGroup {
	...
	public static final String COMPONENT_TYPE = "org.skyve.wildcat.web.faces.components.ListGrid";
...
//					ListGrid.this.getChildren().add(form);
	...
	/*
		<h:form id="listForm" prependId="false">
			<p:dataTable id="list"
							var="row"
							value="#{wildcat.getBeans(wildcat.bizModuleParameter, wildcat.queryNameParameter)}">
				<f:facet name="header">
					<p:outputPanel>
						Contacts
						<p:button href="./?a=#{WebAction.e.toString()}&amp;m=#{wildcat.bizModuleParameter}&amp;d=#{wildcat.bizDocumentParameter}" value="New" />
					</p:outputPanel>
				</f:facet>
