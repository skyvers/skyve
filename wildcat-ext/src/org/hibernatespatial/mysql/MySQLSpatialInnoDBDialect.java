 ...
 * @author Boni Gopalan
 */
public class MySQLSpatialInnoDBDialect extends MySQL5InnoDBDialect implements SpatialDialect {
    ...
    public UserType getGeometryUserType() {
        return dialectDelegate.getGeometryUserType();
    }
    ...
    public boolean isTwoPhaseFiltering() {
        return dialectDelegate.isTwoPhaseFiltering();
    }
