package org.skyve.wildcat.jasperreports;
...
public class WildcatDataSource implements JRDataSource {
	private User user;
	private Iterator<? extends Bean> iterator;
	private Bean currentBean;

	public WildcatDataSource(User user, List<? extends Bean> list) {
		this(user, list.iterator());
	}

	public WildcatDataSource(User user, Iterator<? extends Bean> iterator) {
		this.user = user;
		this.iterator = iterator;
	}

	public WildcatDataSource(User user, Bean bean) {
