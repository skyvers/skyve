...
public class UtilImpl {
	...
	public static final String JAVASCRIPT_FILE_VERSION = "20141118";
	public static final String WILDCAT_VERSION = "20141118";
	public static final String SMART_CLIENT_DIR = "isomorphic10";
