...
public final class OverridableDomainGenerator extends DomainGenerator {
	...
	private static void createMappingFileHeader(FileWriter mappingFileWriter) throws IOException {
		...
		mappingFileWriter.append("\t<typedef name=\"OptimisticLock\" class=\"org.skyve.wildcat.domain.types.OptimisticLockUserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"Decimal2\" class=\"org.skyve.wildcat.domain.types.Decimal2UserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"Decimal5\" class=\"org.skyve.wildcat.domain.types.Decimal5UserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"Decimal10\" class=\"org.skyve.wildcat.domain.types.Decimal10UserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"DateOnly\" class=\"org.skyve.wildcat.domain.types.DateOnlyUserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"DateTime\" class=\"org.skyve.wildcat.domain.types.DateTimeUserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"TimeOnly\" class=\"org.skyve.wildcat.domain.types.TimeOnlyUserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"Timestamp\" class=\"org.skyve.wildcat.domain.types.TimestampUserType\" />\n");
		mappingFileWriter.append("\t<typedef name=\"Enum\" class=\"org.skyve.wildcat.domain.types.EnumUserType\" />\n");
	...
	throws IOException, MetaDataException {
		...
		for (Attribute attribute : document.getAttributes()) {
			...
			if ((! name.equals(Bean.BIZ_KEY)) && 
				...
				if (AttributeType.date.equals(type)) {
					...
					imports.add("org.skyve.wildcat.domain.types.jaxb.DateOnlyMapper");
					...
					imports.add("javax.xml.bind.annotation.XmlSchemaType");
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.TimeOnlyMapper");
					...
					imports.add("javax.xml.bind.annotation.XmlSchemaType");
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.DateTimeMapper");
					...
					imports.add("javax.xml.bind.annotation.XmlSchemaType");
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.TimestampMapper");
					methods.append("\n\t@XmlSchemaType(name = \"dateTime\")");
					methods.append("\n\t@XmlJavaTypeAdapter(TimestampMapper.class)");
				}
				else if (AttributeType.decimal2.equals(type)) {
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.Decimal2Mapper");
					methods.append("\n\t@XmlJavaTypeAdapter(Decimal2Mapper.class)");
				}
				else if (AttributeType.decimal5.equals(type)) {
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.Decimal5Mapper");
					methods.append("\n\t@XmlJavaTypeAdapter(Decimal5Mapper.class)");
				}
				else if (AttributeType.decimal10.equals(type)) {
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.Decimal10Mapper");
					methods.append("\n\t@XmlJavaTypeAdapter(Decimal10Mapper.class)");
				}
				else if (AttributeType.geometry.equals(type)) {
					imports.add("javax.xml.bind.annotation.adapters.XmlJavaTypeAdapter");
					imports.add("org.skyve.wildcat.domain.types.jaxb.GeometryMapper");
		...
		if (baseDocumentName == null) {
			if (persistent != null) {
				...
				imports.add("org.skyve.wildcat.domain.AbstractTransientBean");
			}
		}
