...
public class PersistentHierarchicalDynamicBean extends HierarchicalDynamicBean implements PersistentBean {
	private static final long serialVersionUID = 9192062244299454210L;

	public PersistentHierarchicalDynamicBean(String bizModule, String bizDocument, Map<String, Object> properties) {
