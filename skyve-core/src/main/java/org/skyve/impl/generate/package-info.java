/**
 * Code generators for Skyve domain classes, Hibernate mappings, and view scaffolding.
 *
 * <p>This package contains the engines invoked by the {@code skyve:generateDomain}
 * Maven goal to produce all domain Java source, Hibernate XML mappings, and default view
