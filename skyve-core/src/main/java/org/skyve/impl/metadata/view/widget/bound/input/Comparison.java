...
/**
 * JAXB-annotated comparison widget that renders two document instances
 * side-by-side using a named model.
 *
 * <p>Supports relative sizing, editability, and disabled/invisible conditions.
 *
