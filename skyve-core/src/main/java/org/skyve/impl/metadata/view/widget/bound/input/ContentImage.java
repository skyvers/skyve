...
/**
 * JAXB-annotated content-image widget that displays and optionally allows
 * editing of an image stored as managed content.
 *
 * <p>Bound to a Content attribute; renders the stored image with configurable
 * relative sizing.  When {@code editable} is {@code true}, the user can upload
