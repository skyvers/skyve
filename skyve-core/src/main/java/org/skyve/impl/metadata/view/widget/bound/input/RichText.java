...
/**
 * JAXB-annotated rich-text (HTML) input widget bound to a Long-text String
 * attribute.
 *
 * <p>Renders a WYSIWYG rich-text editor with configurable dimensions and
 * optional content sanitisation.
 *
