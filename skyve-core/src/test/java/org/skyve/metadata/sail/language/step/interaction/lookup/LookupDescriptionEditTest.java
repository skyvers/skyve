...
class LookupDescriptionEditTest {

	private LookupDescriptionEdit step;

	@BeforeEach
	void setUp() {
		step = new LookupDescriptionEdit();
	}
	...
	void executeCallsExecutor() {
		...
		verify(executor).executeLookupDescriptionEdit(step);
	}
	...
	void getIdentifierReturnsDotEdit() {
		...
		assertThat(step.getIdentifier(ctx), is("customer.edit"));
	}
}
