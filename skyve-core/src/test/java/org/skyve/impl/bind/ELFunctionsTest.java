...
class ELFunctionsTest {
	...
	@Test
	@SuppressWarnings("static-method")
	void newDateOnlyFromDate() {
		assertNotNull(ELFunctions.newDateOnlyFromDate(new Date()));
	}

	@Test
	@SuppressWarnings("static-method")
	void newDateOnlyFromSerializedForm() throws ParseException {
	...
	@Test
	@SuppressWarnings("static-method")
	void newTimeOnlyFromSerializedForm() throws ParseException {
		assertNotNull(ELFunctions.newTimeOnlyFromSerializedForm("10:30:00"));
	}

	@Test
	@SuppressWarnings("static-method")
	void newTimeOnlyFromLocalTime() {
	...
	@Test
	@SuppressWarnings("static-method")
	void newGeometry() throws Exception {
