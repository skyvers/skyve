...
class MMM_DD_YYYY_HH_MI_SSTest {
	...
	void testFromDisplayValueAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.fromDisplayValue("Mar-01-2020 02:30:55 AM"), is(testDate));
	}
	...
	void testFromDisplayValuePM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.fromDisplayValue("Mar-01-2020 02:30:55 PM"), is(testDate));
	}
	...
	void testToDisplayValueAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.toDisplayValue(testDate), is("Mar-01-2020 02:30:55 AM"));
	}
	...
	void testToDisplayValuePM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.toDisplayValue(testDate), is("Mar-01-2020 02:30:55 PM"));
	}
}
