...
class MM_DD_YYYY_HH24_MI_SSTest {
	...
	void testFromDisplayValueAM() throws Exception {
		...
		assertThat(formatter.fromDisplayValue("03/01/2020 02:30:05"), is(testDate));
	}
	...
	void testFromDisplayValuePM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.fromDisplayValue("03/01/2020 14:30:55"), is(testDate));
	}
	...
	void testToDisplayValueAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.toDisplayValue(testDate), is("03/01/2020 02:30:55"));
	}
	...
	void testToDisplayValuePM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.toDisplayValue(testDate), is("03/01/2020 14:30:55"));
	}
}
