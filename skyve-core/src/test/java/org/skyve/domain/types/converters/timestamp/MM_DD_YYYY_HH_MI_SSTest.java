...
public class MM_DD_YYYY_HH_MI_SSTest {
	...
	public void testFromDisplayValueAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.fromDisplayValue("03/01/2020 02:30:55 AM"), is(testDate));
	}
	...
	public void testFromDisplayValuePM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.fromDisplayValue("03/01/2020 02:30:55 PM"), is(testDate));
	}
	...
	public void testToDisplayValueAM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.toDisplayValue(testDate), is("03/01/2020 02:30:55 AM"));
	}
	...
	public void testToDisplayValuePM() throws Exception {
		...
		// call the method under test
		assertThat(formatter.toDisplayValue(testDate), is("03/01/2020 02:30:55 PM"));
	}
}
