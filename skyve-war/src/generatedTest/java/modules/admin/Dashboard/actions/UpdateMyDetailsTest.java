 ...
 */
public class UpdateMyDetailsTest extends AbstractActionTest<DashboardExtension, UpdateMyDetails> {

	@Override
	protected UpdateMyDetails getAction() {
		return new UpdateMyDetails();
	}
