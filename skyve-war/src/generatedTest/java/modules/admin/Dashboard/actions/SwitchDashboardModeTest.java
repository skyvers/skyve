 ...
 */
public class SwitchDashboardModeTest extends AbstractActionTest<DashboardExtension, SwitchDashboardMode> {

	@Override
	protected SwitchDashboardMode getAction() {
		return new SwitchDashboardMode();
	}
