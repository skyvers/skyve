 ...
 */
public class DeactivateDashboardTest extends AbstractActionTest<DashboardExtension, DeactivateDashboard> {

	@Override
	protected DeactivateDashboard getAction() {
		return new DeactivateDashboard();
	}
