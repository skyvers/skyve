...
public class DashboardService {
	...
	private final Customer customer = CORE.getCustomer();
	...
	public void activateDashboard(DashboardExtension bean) {
		...
		// If bean is activated then this is an update of the dashboard so clear stuff to due with the home dashboard document
		if (bean.isIndicateActivated()) {
	...
	@SuppressWarnings("static-method")
	public DashboardExtension deactivateDashboard(DashboardExtension dashboard) {
		return dashboard;
	}
