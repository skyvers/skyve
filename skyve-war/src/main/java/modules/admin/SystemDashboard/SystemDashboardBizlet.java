...
public class SystemDashboardBizlet extends Bizlet<SystemDashboard> {
	...
	public SystemDashboard newInstance(SystemDashboard bean) throws Exception {
		...
		passwordSelfResetConfigured.setText5001(formatBooleanHTML(UtilImpl.GOOGLE_RECAPTCHA_SITE_KEY != null || UtilImpl.CLOUDFLARE_TURNSTILE_SITE_KEY != null, valTrue, valFalse,
