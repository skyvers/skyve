...
isc.PickListMenu.addMethods({
    ...
    multiSelectChanged : function () {
        var formItem = this.formItem,
            ...
            selLength = (sel == null ? 0 : sel.length);
        formItem.pickValue(selLength == 0 ? null : sel.getProperty(fieldName));
    },
...
isc.PickList.addInterfaceMethods({
    ...
    _pickListShown : function () {
        if (isc.Canvas.ariaEnabled()) {
            ...
            this.setAriaState("owns", this.pickList._getClipDivDOMID());
        }
    ...
    selectItemFromValue : function (value, dontScroll) {
        ...
        for (var i = 0; i < value.length; i++) {
            ...
            if (records != null && records.find(valueField, currVal)) continue;
