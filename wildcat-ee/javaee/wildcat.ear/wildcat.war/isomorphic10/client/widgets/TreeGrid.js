...
//    sortFoldersBeforeLeaves:null,
    ...
    // Should the +link{treeGrid.openerImage,opener icon}
    // be displayed next to folder nodes? This is an icon
...
_fixTitleWidth:function () {
    ...
    return this.fixedFieldWidths && !this.autoFitFieldWidths && !gettingAutoSize;
},
...
getIndentHTML : function (level, record, treeCellTemplate, indentCellWidthOffset) {
    ...
    var indentWidth = (this.showConnectors ? this.getOpenerIconWidth(record) : this.indentSize),
        ...
        shift1px = this.isPrinting || isc.Browser.isIE || isc.Browser.isOpera,
...
getOpenerImageURL : function (hasChildren, isOpen, startLine, endLine) {   
    ...
    if (this.showConnectors) {
        ...
        if (hasChildren || this.alwaysShowOpener) {
            if (isOpen) {
        ...
        // with children.
        if (!hasChildren && !this.alwaysShowOpener) return null;
