...
isc.DateRangeItem.addMethods({
    ...
    getValue : function () {
        ...
        if (fFrom) {
            fromValue = isRelative && fFrom.getRelativeDate ? fFrom.getRelativeDate() : fFrom.getValue();
        }
        if (fromValue == null) fromValue = this.fromDate;
        
        if (fTo) {
            toValue = isRelative && fTo.getRelativeDate ? fTo.getRelativeDate() : fTo.getValue();
        }
        if (toValue == null) toValue = this.toDate;
