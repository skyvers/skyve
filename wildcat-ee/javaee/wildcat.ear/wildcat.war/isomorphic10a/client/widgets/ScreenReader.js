...
isc.Canvas.addMethods({
    ...
    getAriaStateAttributes : function () {
        return isc.Canvas.getAriaStateAttributes(this.getAriaState != null ? this.getAriaState() : this.ariaState);
    }
});
...
isc.StatefulCanvas.addProperties({
    ...
    getAriaState : function () {
        ...
        if (this.label != null) ariaState.labelledby = this.label._getAriaHandleID();
        return ariaState;
    }
});
        ...
        if (this.title) {
            ...
            if (titleElement != null) {
                ...
                if (labelElement != null) {
                    ...
                    if (title != null) {
                        title = String(title).unescapeHTML();
                    }
                    isc.Canvas.setAriaState(titleElement, "label", title);
