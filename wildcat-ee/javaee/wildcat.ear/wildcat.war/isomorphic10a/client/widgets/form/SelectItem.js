...
isc.SelectItem.addMethods({
    ...
    moveToChar : function (charVal) {
                ...
                (this.multiple && this.openPickListOnKeyPress && i < valsArray.length))
        {
            ...
            if (!this.multiple && currentIndex < 0) currentIndex = 0;
    ...
    setElementValue : function (displayValue, dataValue, a,b,c) {
        ...
        var isEmptyDisplayValue = (displayValue == null ||
    ...
    getSelectedRecords : function () {
        ...
        return (sel != null && sel.length > 0 ? sel : null);
    },
    ...
    updateValueMap : function (refreshDisplay) {
        ...
        if (reShowPickList) this.showPickList();
    },
