...
layoutChildren : function (a,b,c,d) {
    ...
    if (this.autoSize && !this._settingProperties) this._matchBodyWidth();
...
isc.Dialog.Warn = {
    ...
    showMessage : function (newMessage, properties) {
        ...
        // store a flag that setProperties is running - don't allow relayout while this is the
        // case because it interferes with user-supplied sizes
        this._settingProperties = true;
        this.setProperties(properties);
        delete this._settingProperties;
        ...
        if (autoSize && !this.autoSize) {
            this.setAutoSize(true);
        } else if (!autoSize && this.autoSize) {
            this.setAutoSize(false);
        }
