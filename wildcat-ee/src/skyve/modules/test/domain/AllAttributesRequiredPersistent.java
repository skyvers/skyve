...
public class AllAttributesRequiredPersistent extends AbstractPersistentBean {
	...
	private List<AllAttributesRequiredPersistent> aggregatedCollection = new ArrayList<>();
	...
	public static AllAttributesRequiredPersistent newInstance() throws Exception {
	...
	public boolean equals(Object o) {
		return ((o instanceof AllAttributesRequiredPersistent) && 
					this.getBizId().equals(((AllAttributesRequiredPersistent) o).getBizId()));
	}
	 ...
	 **/
	public void setAggregatedCollectionElementById(@SuppressWarnings("unused") String bizId, AllAttributesRequiredPersistent element) {
