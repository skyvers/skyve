...
@XmlType
@XmlRootElement
public class AllAttributesInverseOneToOnePersistent extends AbstractPersistentBean {
	/**
	 * For Serialization
	 * @hidden
	 */
	...
	public String getBizModule() {
		return AllAttributesInverseOneToOnePersistent.MODULE_NAME;
	}

	@Override
	@XmlTransient
	public String getBizDocument() {
		return AllAttributesInverseOneToOnePersistent.DOCUMENT_NAME;
	}

	public static AllAttributesInverseOneToOnePersistent newInstance() throws Exception {
	...
	public boolean equals(Object o) {
		return ((o instanceof AllAttributesInverseOneToOnePersistent) && 
					this.getBizId().equals(((AllAttributesInverseOneToOnePersistent) o).getBizId()));
	}
